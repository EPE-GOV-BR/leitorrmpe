...
#'
#' Faz a leitura dos arquivos do NEWAVE com dados de energia vertida para o SIN  
#' (evertsin.*) e recupera esses valores por ano, mes e serie.
...
#'
#' @param pasta localizacao dos arquivos evertsin.* do NWLISTOP
#'
#' @return \code{df.energiaVertidaSin} data frame com os valores de energia 
#' vertida para o SIN
#' \itemize{
...
leituraEnergiaVertidaSin <- function(pasta) {
  ...
  df.energiaVertidaSin <- tidyr::tibble(codSubmercado = numeric(), 
                                        serie = numeric(), 
                                        anoMes = numeric(), 
                                        vertimento = numeric())
