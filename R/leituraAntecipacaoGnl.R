...
#'
#' Faz a leitura do arquivo do NEWAVE com dados de antecipação de despacho de 
#' usinas térmicas GNL (adterm.dat)
...
#'
#' @return \code{df.antecipacaoDespachoGnl} data frame com os dados de 
#' antecipação de despacho de usinas térmicas GNL
#' \itemize{
...
leituraAntecipacaoGnl <- function(pastaCaso) {
  ...
  # encontra o nome do arquivo adterm de acordo com a ordem informada no manual 
  # do NEWAVE para o arquivos.dat
