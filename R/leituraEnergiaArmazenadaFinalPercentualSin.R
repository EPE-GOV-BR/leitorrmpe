...
#'
#' Faz a leitura dos arquivos do NEWAVE com dados de armazenamento percentual 
#' para o Sistema Interligado Nacional  (earmfpsin.*) e recupera esses valores 
#' por ano, mes e serie.
...
#'
#' @param pasta localizacao dos arquivos do NEWAVE com dados de armazenamento 
#' percentual do SIN
#'
#' @return \code{df.earmfpSin} data frame com os valores de energia vertida para 
#' o SIN
#' \itemize{
...
leituraEnergiaArmazenadaFinalPercentualSin <- function(pasta) {
  ...
  df.earmfpSin <- tidyr::tibble(serie = numeric(), 
                                anoMes = numeric(), 
                                earmfp = numeric())
