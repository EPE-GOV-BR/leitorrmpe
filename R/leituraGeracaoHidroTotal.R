...
#' por REE (ghtotxxx.*) e recupera esses valores por ano, mes, patamar e serie.
...
#'
#' @return \code{df.geracaoHidroTotal} data frame com os valores de geracao
#' hidroeletrica total por REE
#' \itemize{
...
#' leituraGeracaoHidroTotal("C:/PDE2027_Caso080", paralelo = TRUE)
#' }
#'
#' @export
leituraGeracaoHidroTotal <- function(pasta, paralelo = FALSE) {
  if (missing(pasta)) {
    stop("favor indicar a pasta com os arquivos do NEWAVE")
  }

  # cria data frame de base para armazenar os dados de energia armazenada
  # final para todos os anos
  ...
  df.geracaoHidroTotal <- furrr::future_map_dfr(arquivos, function(arquivo) {
