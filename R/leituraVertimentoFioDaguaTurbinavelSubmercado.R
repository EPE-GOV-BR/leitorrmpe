...
#' @examples
#' \dontrun{
#' leituraVertimentoFioDaguaTurbinavelSubmercado("C:/PDE2027_Caso080")}
#'
#' @export
...
leituraVertimentoFioDaguaTurbinavelSubmercado <- function(pasta) {
  ...
  df.vertimentoFioDaguaTurbinavelSubmercado <- purrr::map_df(arquivos, function(arquivo) {
    ...
    inicioSubmercado <- stringr::str_locate(arquivo, "verturbm") %>% {.[1,2] + 1} %>% unname()
